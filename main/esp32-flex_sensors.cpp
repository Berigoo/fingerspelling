...
void app_main(void)
{
  ...
  adc_unit_context = adc_unit_create(ADC_UNIT_1);
  
  flex_thumb_context = flex_create(adc_unit_context, ADC_CHANNEL_0);
  flex_index_context = flex_create(adc_unit_context, ADC_CHANNEL_1);
  flex_middle_context = flex_create(adc_unit_context, ADC_CHANNEL_2);
  flex_ring_context = flex_create(adc_unit_context, ADC_CHANNEL_3);
  flex_pinky_context = flex_create(adc_unit_context, ADC_CHANNEL_4);  
